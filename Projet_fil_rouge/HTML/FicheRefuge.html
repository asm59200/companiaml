  ...
  <!-- Debut Fiche Perdu Trouver-->
    <div class="Fiche">
        <div class="container-fluid">
          ...
          <!-- Image Fiche Animal-->      
                  <div class="Background-Color-Fiche-Image">
                    <img class="Image-Fiche" src="../img/5b0df5cfe8f92b640b8b4774.jpg">
                  </div>
          <!-- Texte Fiche Animal-->
                  <div class="Background-Color-Fiche-Texte">
                      <h3 style="text-align:center; padding-top: 20px;">Nom du Refuge</h3>
                    <div class="row">
                      <div class="col-lg-4 offset-lg-1 col-10 offset-1">
                        <p> Adresse du Refuge : </p>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <p style="text-align: center"> Information sur le Refuge : </p>
                    <div class="row">
        ...
        <div class=" row justify-content-center">
          <button type="button" class="btn btn-lg Bouton-Admin-2">Contactez-Nous </button>
          <button type="button" class="btn btn-lg Bouton-Admin-2">06.06.06.06.06.06</button>
        </div>
                </div>
              </div>
            </div>
